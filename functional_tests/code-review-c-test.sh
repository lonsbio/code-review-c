...
this_program_name="code-review-c-test.sh"
...
${this_program_name}: run integration/regression tests for code-review-c 

Usage:
    ${this_program_name} [-h] [-v] -p program -d test_data_dir 

Example:
    ${this_program_name} -p bin/code-review-c -d data/tests
